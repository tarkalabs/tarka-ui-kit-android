...
val lightColors = TUIColors(
  ...
  onSuccess10 = Color(0xFF148F47).copy(alpha = 0.10f),
  onSuccess20 = Color(0xFF148F47).copy(alpha = 0.20f),
  error = Color(0xFFCD1D32),
  onError = Color(0xFFFEFBFB),
  onError10 = Color(0xFFCD1D32).copy(alpha = 0.10f),
  warning = Color(0xFFFFB938),
  onWarning = Color(0xFF241D0F),
  onWarning10 = Color(0xFF241D0F).copy(alpha = 0.10f),
...
val darkColors = TUIColors(
  ...
  onSuccess10 = Color(0xFF003817).copy(alpha = 0.10f),
  onSuccess20 = Color(0xFF003817).copy(alpha = 0.20f),
  error = Color(0xFFD42136),
  onError = Color(0xFFFFFAFA),
  onError10 = Color(0xFFFFFAFA).copy(alpha = 0.10f),
  warning = Color(0xFFFFB938),
  onWarning = Color(0xFF241D0F),
  onWarning10 = Color(0xFF241D0F).copy(alpha = 0.10f),
